...
def get_bert_embedding(all_sens, model, tokenizer, idf_dict, batch_size=-1, device="cpu", all_layers=False):
    """
...
def bert_cos_score_idf(
    model, refs, hyps, tokenizer, idf_dict, verbose=False, batch_size=64, device="cpu", all_layers=False,
):
    """
    Compute BERTScore.
